  ...
  if edtNome.Text = '' then
    ...
    begin
      if gblNomeTabela = 'tb_clientes' then
        ...
        if gblNomeTabela = 'tb_pedidovenda' then
          PedidoVenda.PesquisaTabela(gblNomeTabela, gblCodigo, gblNomepesquisa, Trim(edtNome.Text))
      else
        if gblNomeTabela = 'tb_pedidos_produtos' then
          PedidoProdutos.PesquisaTabela(gblNomeTabela, gblCodigo, gblNomepesquisa, Trim(edtNome.Text));
    end;
end;
