object frmMov_PEDVendas: TfrmMov_PEDVendas
    ...
    object pn_Grid: TPanel
      ...
      object Panel4: TPanel
        ...
        object Grd_Pedido: TDBGrid
          ...
          Font.Name = 'Tahoma'
          Font.Style = [fsBold]
          Options = [dgTitles, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgTitleHotTrack]
          ParentFont = False
          TabOrder = 0
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
  ...
  object QryConsPedido: TFDQuery
    ...
    SQL.Strings = (
      ...
      '       pe.VALOR_TOTAL,'
      '       tpp.CODPRODUTO,'
      '       tp.DESCRICAO as DESCRPRODUTO,'
      '       tpp.QUANTIDADE,'
      '       tpp.VALOR_UNITARIO,'
      '       tpp.VALOR_TOTAL AS VALOR_TOTAL_ITE'
      'from tb_pedidovenda pe'
      '     inner join tb_clientes cl on cl.CODIGO = pe.CODCLIENTE'
      
        '     inner join tb_pedidos_produtos tpp on tpp.NUMPEDIDO = pe.NU' +
        'MPEDIDO'
      '     inner join tb_produtos tp on tp.CODIGO = tpp.CODPRODUTO'
  ...
  object QryPedido: TFDQuery
    Connection = DM.DBConexao
    SQL.Strings = (
      'select NUMPEDIDO from tb_pedidovenda tp ')
    Left = 1000
    Top = 359
    object QryPedidoNUMPEDIDO: TFDAutoIncField
